-- ============================================================================
-- LIVE SCHEMA SYNC (ADDITIVE / NON-DESTRUCTIVE)
-- Generated from compliance_all.sql
-- Generated at: 2026-08-25T07:54:44.042Z
-- Target: MySQL 8.0+
--
-- Safety contract:
--   * Never drops a business table or column.
--   * Never deletes or updates table data.
--   * Creates missing tables, columns, indexes and foreign keys only.
--   * Existing columns/indexes/constraints are left unchanged, even if their
--     definitions differ from the source dump.
--   * Stored routines are replaced so their definitions match the source dump.
--
-- Run against the intended database, for example:
--   mysql --default-character-set=utf8mb4 -u USER -p DATABASE \
--     < compliance_live_schema_sync.sql
-- ============================================================================

SET @schema_sync_old_character_set_client = @@character_set_client;
SET @schema_sync_old_character_set_results = @@character_set_results;
SET @schema_sync_old_collation_connection = @@collation_connection;
SET @schema_sync_old_time_zone = @@time_zone;
SET @schema_sync_old_sql_mode = @@sql_mode;
SET @schema_sync_old_foreign_key_checks = @@foreign_key_checks;
SET @schema_sync_old_unique_checks = @@unique_checks;
SET NAMES utf8mb4;
SET time_zone = '+00:00';
SET foreign_key_checks = 0;
SET unique_checks = 0;

SELECT GET_LOCK(CONCAT(DATABASE(), ':compliance_live_schema_sync'), 30)
  INTO @schema_sync_lock_acquired;

DELIMITER $$
DROP PROCEDURE IF EXISTS _schema_sync_require_lock$$
CREATE PROCEDURE _schema_sync_require_lock()
BEGIN
  IF COALESCE(@schema_sync_lock_acquired, 0) <> 1 THEN
    SIGNAL SQLSTATE '45000'
      SET MESSAGE_TEXT = 'Could not acquire compliance schema migration lock';
  END IF;
END$$
CALL _schema_sync_require_lock()$$
DROP PROCEDURE _schema_sync_require_lock$$

DROP PROCEDURE IF EXISTS _schema_sync_add_column$$
CREATE PROCEDURE _schema_sync_add_column(
...
BEGIN
  IF NOT EXISTS (
    ...
    SET @schema_sync_sql = CONCAT(
      'ALTER TABLE ', CHAR(96), REPLACE(p_table_name, CHAR(96), CONCAT(CHAR(96), CHAR(96))),
      CHAR(96), ' ADD COLUMN ', p_definition
    );
...
DROP PROCEDURE IF EXISTS _schema_sync_add_index$$
CREATE PROCEDURE _schema_sync_add_index(
  IN p_table_name VARCHAR(64),
...
DROP PROCEDURE IF EXISTS _schema_sync_add_foreign_key$$
CREATE PROCEDURE _schema_sync_add_foreign_key(
  IN p_table_name VARCHAR(64),
...
-- Create tables that do not exist. Existing tables and their data are untouched.

CREATE TABLE IF NOT EXISTS `compl_code_sequences` (
...
CREATE TABLE IF NOT EXISTS `compl_compliance_group_email` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `compl_compliances` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `compl_config` (
...
CREATE TABLE IF NOT EXISTS `compl_country_group_members` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `compl_country_groups` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `compl_document_type` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `compl_group_email` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
  `Name` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `compl_group_email_detail` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
  `GroupEmailId` bigint NOT NULL,
  `Name` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `compl_history` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `compl_job_schedule_configs` (
...
CREATE TABLE IF NOT EXISTS `compl_master_condition_values` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `compl_master_conditions` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `compl_master_default_configs` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `compl_master_default_logs` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `compl_master_default_template_condition_values` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
  `ConditionId` bigint NOT NULL,
  `RefTypeValue` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `compl_master_default_template_conditions` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `compl_master_default_template_group_email` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
  `TemplateId` bigint NOT NULL,
  `GroupEmailId` bigint NOT NULL,
  `GroupType` tinyint NOT NULL,
...
CREATE TABLE IF NOT EXISTS `compl_master_default_templates` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
  `ConfigId` bigint NOT NULL,
  `Name` varchar(255) NOT NULL,
  `ValidFrom` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `compl_master_default_trigger_condition_values` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
  `ConditionId` bigint NOT NULL,
  `RefTypeValue` varchar(255) NOT NULL,
  `SortOrder` int NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `compl_master_default_trigger_conditions` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
  `ConfigId` bigint NOT NULL,
  `TriggerId` bigint NOT NULL COMMENT 'FK compl_ref_trigger',
  `TriggerRefTypeId` bigint NOT NULL,
...
CREATE TABLE IF NOT EXISTS `compl_master_group_email` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
  `MasterId` bigint NOT NULL,
  `GroupEmailId` bigint NOT NULL,
  `GroupType` tinyint NOT NULL,
...
CREATE TABLE IF NOT EXISTS `compl_masters` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
  `Code` varchar(50) NOT NULL,
  `Name` varchar(255) NOT NULL,
  `ValidFrom` datetime NOT NULL,
...
CREATE TABLE IF NOT EXISTS `compl_notifications` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `compl_ref_tracked_objects` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `compl_ref_trigger` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
  `RefTypeId` bigint NOT NULL COMMENT 'FK to compl_reference_types',
...
CREATE TABLE IF NOT EXISTS `compl_reference_types` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `compl_references` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
  `MasterId` bigint NOT NULL,
  `ComplianceId` bigint NOT NULL,
  `ComplType` tinyint NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `compl_sharepoint_files` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `compl_so_missing` (
...
CREATE TABLE IF NOT EXISTS `compl_summary_so` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `compl_sync_sales_line` (
...
CREATE TABLE IF NOT EXISTS `compl_sync_variant_attributes` (
  `Id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `compl_user_grid_preference` (
  `Id` bigint NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `eutr_documents` (
  `Id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `Name` varchar(255) DEFAULT NULL,
  `FileId` varchar(255) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `eutr_master_documents` (
  `Id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `eutr_purchase_attachments` (
...
CREATE TABLE IF NOT EXISTS `eutr_purchase_missing` (
  `Id` int unsigned NOT NULL AUTO_INCREMENT,
  `PurchId` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `eutr_reference_details` (
  `Id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `eutr_reference_type_details` (
  `Id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `StepId` bigint unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `eutr_reference_types` (
...
CREATE TABLE IF NOT EXISTS `eutr_references` (
  `Id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `RefId` bigint unsigned DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `eutr_steps` (
  `Id` bigint unsigned NOT NULL AUTO_INCREMENT,
  `Name` varchar(255) DEFAULT NULL,
  `CreatedBy` varchar(50) DEFAULT NULL,
  `CreatedDate` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `eutr_template_details` (
  `Id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `eutr_template_references` (
  `Id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `eutr_templates` (
  `Id` bigint unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `hf_AggregatedCounter` (
  `Id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `hf_Counter` (
  `Id` int NOT NULL AUTO_INCREMENT,
  `Key` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `Value` int NOT NULL,
  `ExpireAt` datetime DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `hf_Hash` (
  `Id` int NOT NULL AUTO_INCREMENT,
  `Key` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hf_Job` (
  `Id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `hf_JobParameter` (
  `Id` int NOT NULL AUTO_INCREMENT,
  `JobId` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hf_JobQueue` (
  `Id` int NOT NULL AUTO_INCREMENT,
  `JobId` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hf_JobState` (
  `Id` int NOT NULL AUTO_INCREMENT,
  `JobId` int NOT NULL,
  `CreatedAt` datetime(6) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `hf_List` (
  `Id` int NOT NULL AUTO_INCREMENT,
  `Key` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `Value` longtext,
  `ExpireAt` datetime(6) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `hf_Server` (
...
CREATE TABLE IF NOT EXISTS `hf_Set` (
  `Id` int NOT NULL AUTO_INCREMENT,
  `Key` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
...
CALL _schema_sync_add_column('compl_code_sequences', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_code_sequences', 'Prefix', '`Prefix` varchar(20) NOT NULL');
CALL _schema_sync_add_column('compl_code_sequences', 'Separator', '`Separator` char(1) DEFAULT ''-''');
CALL _schema_sync_add_column('compl_code_sequences', 'Number', '`Number` int NOT NULL DEFAULT ''0''');
CALL _schema_sync_add_column('compl_code_sequences', 'PaddingLength', '`PaddingLength` int DEFAULT ''5''');
CALL _schema_sync_add_column('compl_code_sequences', 'CreatedDate', '`CreatedDate` datetime DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_code_sequences', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_compliance_group_email', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_compliance_group_email', 'ComplianceId', '`ComplianceId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_compliance_group_email', 'GroupEmailId', '`GroupEmailId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_compliance_group_email', 'GroupType', '`GroupType` tinyint NOT NULL');
CALL _schema_sync_add_column('compl_compliance_group_email', 'CreatedDate', '`CreatedDate` datetime DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_compliance_group_email', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_compliances', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_compliances', 'Code', '`Code` varchar(100) NOT NULL');
CALL _schema_sync_add_column('compl_compliances', 'Name', '`Name` varchar(255) NOT NULL');
CALL _schema_sync_add_column('compl_compliances', 'ValidFrom', '`ValidFrom` datetime NOT NULL');
CALL _schema_sync_add_column('compl_compliances', 'ValidTo', '`ValidTo` datetime DEFAULT NULL');
CALL _schema_sync_add_column('compl_compliances', 'FileId', '`FileId` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('compl_compliances', 'Description', '`Description` varchar(1000) DEFAULT NULL');
CALL _schema_sync_add_column('compl_compliances', 'NumDayAlert', '`NumDayAlert` int DEFAULT NULL');
CALL _schema_sync_add_column('compl_compliances', 'DocumentTypeId', '`DocumentTypeId` bigint DEFAULT NULL');
CALL _schema_sync_add_column('compl_compliances', 'DocumentValue', '`DocumentValue` text');
CALL _schema_sync_add_column('compl_compliances', 'IsDelete', '`IsDelete` tinyint(1) DEFAULT ''0''');
CALL _schema_sync_add_column('compl_compliances', 'VersionNo', '`VersionNo` int DEFAULT ''1''');
CALL _schema_sync_add_column('compl_compliances', 'ReplacedById', '`ReplacedById` bigint DEFAULT NULL');
CALL _schema_sync_add_column('compl_compliances', 'CreatedDate', '`CreatedDate` datetime DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_compliances', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_compliances', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_compliances', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_config', 'ConfigKey', '`ConfigKey` varchar(100) NOT NULL');
CALL _schema_sync_add_column('compl_config', 'ConfigValue', '`ConfigValue` varchar(500) DEFAULT NULL');
CALL _schema_sync_add_column('compl_config', 'Description', '`Description` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('compl_config', 'CreatedDate', '`CreatedDate` datetime DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_config', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_config', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_config', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_country_group_members', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_country_group_members', 'GroupId', '`GroupId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_country_group_members', 'CountryCode', '`CountryCode` varchar(10) NOT NULL COMMENT ''ISO 3-letter: DEU, FRA, ...''');
CALL _schema_sync_add_column('compl_country_groups', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_country_groups', 'Code', '`Code` varchar(20) NOT NULL COMMENT ''VD: EU, ASEAN, G7''');
CALL _schema_sync_add_column('compl_country_groups', 'Name', '`Name` varchar(100) NOT NULL');
CALL _schema_sync_add_column('compl_country_groups', 'Description', '`Description` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('compl_country_groups', 'IsActive', '`IsActive` tinyint(1) DEFAULT ''1''');
CALL _schema_sync_add_column('compl_country_groups', 'CreatedDate', '`CreatedDate` datetime DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_country_groups', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_country_groups', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_country_groups', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_document_type', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_document_type', 'Name', '`Name` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('compl_document_type', 'Location', '`Location` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('compl_document_type', 'CreatedDate', '`CreatedDate` datetime DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_document_type', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_document_type', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_document_type', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_group_email', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_group_email', 'Name', '`Name` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('compl_group_email', 'GroupType', '`GroupType` tinyint DEFAULT NULL');
CALL _schema_sync_add_column('compl_group_email', 'IsDefault', '`IsDefault` tinyint(1) DEFAULT NULL');
CALL _schema_sync_add_column('compl_group_email', 'IsAddition', '`IsAddition` tinyint(1) DEFAULT ''0''');
CALL _schema_sync_add_column('compl_group_email', 'CreatedDate', '`CreatedDate` datetime DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_group_email', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_group_email', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_group_email', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_group_email_detail', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_group_email_detail', 'GroupEmailId', '`GroupEmailId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_group_email_detail', 'Name', '`Name` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('compl_group_email_detail', 'ResponseEmail', '`ResponseEmail` varchar(100) DEFAULT NULL');
CALL _schema_sync_add_column('compl_group_email_detail', 'ExternalEmail', '`ExternalEmail` varchar(100) DEFAULT NULL');
CALL _schema_sync_add_column('compl_group_email_detail', 'IsActive', '`IsActive` tinyint(1) DEFAULT ''1''');
CALL _schema_sync_add_column('compl_group_email_detail', 'CreatedDate', '`CreatedDate` datetime DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_group_email_detail', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_group_email_detail', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_group_email_detail', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_history', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_history', 'TableName', '`TableName` varchar(100) NOT NULL');
CALL _schema_sync_add_column('compl_history', 'RecordId', '`RecordId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_history', 'RecordCode', '`RecordCode` varchar(45) DEFAULT NULL');
CALL _schema_sync_add_column('compl_history', 'Action', '`Action` varchar(50) NOT NULL');
CALL _schema_sync_add_column('compl_history', 'ActionDetail', '`ActionDetail` text');
CALL _schema_sync_add_column('compl_history', 'OldValue', '`OldValue` json DEFAULT NULL');
CALL _schema_sync_add_column('compl_history', 'NewValue', '`NewValue` json DEFAULT NULL');
CALL _schema_sync_add_column('compl_history', 'ActionDate', '`ActionDate` datetime DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_history', 'ActionBy', '`ActionBy` varchar(100) NOT NULL');
CALL _schema_sync_add_column('compl_history', 'IsVersionChange', '`IsVersionChange` tinyint(1) DEFAULT ''0''');
CALL _schema_sync_add_column('compl_job_schedule_configs', 'Id', '`Id` int NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_job_schedule_configs', 'JobId', '`JobId` varchar(100) NOT NULL COMMENT ''Hangfire job key, e.g. sent_alert_compliance''');
CALL _schema_sync_add_column('compl_job_schedule_configs', 'JobName', '`JobName` varchar(200) NOT NULL COMMENT ''Tên hiển thị''');
CALL _schema_sync_add_column('compl_job_schedule_configs', 'Description', '`Description` text COMMENT ''Mô tả chức năng''');
CALL _schema_sync_add_column('compl_job_schedule_configs', 'ServiceType', '`ServiceType` varchar(500) NOT NULL COMMENT ''Full interface name, e.g. IComplNotificationService''');
CALL _schema_sync_add_column('compl_job_schedule_configs', 'MethodName', '`MethodName` varchar(200) NOT NULL COMMENT ''Tên method được gọi''');
CALL _schema_sync_add_column('compl_job_schedule_configs', 'CronExpression', '`CronExpression` varchar(100) NOT NULL COMMENT ''VD: 0 3 * * *''');
CALL _schema_sync_add_column('compl_job_schedule_configs', 'Timezone', '`Timezone` varchar(100) NOT NULL DEFAULT ''SE Asia Standard Time''');
CALL _schema_sync_add_column('compl_job_schedule_configs', 'Queue', '`Queue` varchar(50) NOT NULL DEFAULT ''default''');
CALL _schema_sync_add_column('compl_job_schedule_configs', 'IsEnabled', '`IsEnabled` tinyint(1) NOT NULL DEFAULT ''1''');
CALL _schema_sync_add_column('compl_job_schedule_configs', 'CreatedAt', '`CreatedAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_job_schedule_configs', 'UpdatedAt', '`UpdatedAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_job_schedule_configs', 'CreatedBy', '`CreatedBy` varchar(200) DEFAULT NULL');
CALL _schema_sync_add_column('compl_job_schedule_configs', 'UpdatedBy', '`UpdatedBy` varchar(200) DEFAULT NULL');
CALL _schema_sync_add_column('compl_master_condition_values', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_master_condition_values', 'ConditionId', '`ConditionId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_master_condition_values', 'RefTypeValue', '`RefTypeValue` varchar(255) NOT NULL');
CALL _schema_sync_add_column('compl_master_conditions', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_master_conditions', 'MasterId', '`MasterId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_master_conditions', 'RefTypeId', '`RefTypeId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_master_conditions', 'Operator', '`Operator` varchar(10) NOT NULL DEFAULT ''=''');
CALL _schema_sync_add_column('compl_master_conditions', 'Logical', '`Logical` int DEFAULT ''1''');
CALL _schema_sync_add_column('compl_master_conditions', 'ComplType', '`ComplType` tinyint NOT NULL DEFAULT ''0''');
CALL _schema_sync_add_column('compl_master_conditions', 'DisplayType', '`DisplayType` int DEFAULT ''0''');
CALL _schema_sync_add_column('compl_master_default_configs', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_master_default_configs', 'Code', '`Code` varchar(50) NOT NULL');
CALL _schema_sync_add_column('compl_master_default_configs', 'Name', '`Name` varchar(255) NOT NULL');
CALL _schema_sync_add_column('compl_master_default_configs', 'Note', '`Note` varchar(500) DEFAULT NULL');
CALL _schema_sync_add_column('compl_master_default_configs', 'TriggerId', '`TriggerId` bigint NOT NULL COMMENT ''FK compl_ref_trigger''');
CALL _schema_sync_add_column('compl_master_default_configs', 'TriggerRefTypeId', '`TriggerRefTypeId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_master_default_configs', 'IsActive', '`IsActive` tinyint(1) NOT NULL DEFAULT ''1''');
CALL _schema_sync_add_column('compl_master_default_configs', 'CreatedDate', '`CreatedDate` datetime DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_master_default_configs', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_master_default_configs', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_master_default_configs', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_master_default_logs', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_master_default_logs', 'ConfigId', '`ConfigId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_master_default_logs', 'TemplateId', '`TemplateId` bigint DEFAULT NULL');
CALL _schema_sync_add_column('compl_master_default_logs', 'TrackedObjectId', '`TrackedObjectId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_master_default_logs', 'CreatedMasterId', '`CreatedMasterId` bigint DEFAULT NULL');
CALL _schema_sync_add_column('compl_master_default_logs', 'Status', '`Status` enum(''SUCCESS'',''FAILED'',''SKIPPED'') NOT NULL DEFAULT ''SUCCESS''');
CALL _schema_sync_add_column('compl_master_default_logs', 'ErrorMessage', '`ErrorMessage` text');
CALL _schema_sync_add_column('compl_master_default_logs', 'ProcessedAt', '`ProcessedAt` datetime DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_master_default_logs', 'IsSendMail', '`IsSendMail` tinyint(1) NOT NULL DEFAULT ''0'' COMMENT ''Flag indicating whether a mail has been sent for this log entry''');
CALL _schema_sync_add_column('compl_master_default_template_condition_values', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_master_default_template_condition_values', 'ConditionId', '`ConditionId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_master_default_template_condition_values', 'RefTypeValue', '`RefTypeValue` varchar(255) NOT NULL');
CALL _schema_sync_add_column('compl_master_default_template_condition_values', 'SortOrder', '`SortOrder` int NOT NULL DEFAULT ''0''');
CALL _schema_sync_add_column('compl_master_default_template_conditions', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_master_default_template_conditions', 'TemplateId', '`TemplateId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_master_default_template_conditions', 'RefTypeId', '`RefTypeId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_master_default_template_conditions', 'ValueSource', '`ValueSource` enum(''NEW_VALUE'',''FIXED'',''NOT_IN'') NOT NULL');
CALL _schema_sync_add_column('compl_master_default_template_conditions', 'Operator', '`Operator` varchar(10) NOT NULL DEFAULT ''IN''');
CALL _schema_sync_add_column('compl_master_default_template_conditions', 'Logical', '`Logical` int NOT NULL DEFAULT ''1''');
CALL _schema_sync_add_column('compl_master_default_template_conditions', 'ComplType', '`ComplType` tinyint NOT NULL DEFAULT ''0''');
CALL _schema_sync_add_column('compl_master_default_template_conditions', 'DisplayType', '`DisplayType` int DEFAULT ''0''');
CALL _schema_sync_add_column('compl_master_default_template_conditions', 'SortOrder', '`SortOrder` int NOT NULL DEFAULT ''0''');
CALL _schema_sync_add_column('compl_master_default_template_group_email', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_master_default_template_group_email', 'TemplateId', '`TemplateId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_master_default_template_group_email', 'GroupEmailId', '`GroupEmailId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_master_default_template_group_email', 'GroupType', '`GroupType` tinyint NOT NULL');
CALL _schema_sync_add_column('compl_master_default_template_group_email', 'CreatedDate', '`CreatedDate` datetime DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_master_default_template_group_email', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_master_default_templates', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_master_default_templates', 'ConfigId', '`ConfigId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_master_default_templates', 'Name', '`Name` varchar(255) NOT NULL');
CALL _schema_sync_add_column('compl_master_default_templates', 'ValidFrom', '`ValidFrom` datetime NOT NULL');
CALL _schema_sync_add_column('compl_master_default_templates', 'ValidTo', '`ValidTo` datetime DEFAULT NULL');
CALL _schema_sync_add_column('compl_master_default_templates', 'NumDayAlert', '`NumDayAlert` int DEFAULT ''60''');
CALL _schema_sync_add_column('compl_master_default_templates', 'Description', '`Description` varchar(500) DEFAULT NULL');
CALL _schema_sync_add_column('compl_master_default_templates', 'SortOrder', '`SortOrder` int NOT NULL DEFAULT ''0''');
CALL _schema_sync_add_column('compl_master_default_trigger_condition_values', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_master_default_trigger_condition_values', 'ConditionId', '`ConditionId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_master_default_trigger_condition_values', 'RefTypeValue', '`RefTypeValue` varchar(255) NOT NULL');
CALL _schema_sync_add_column('compl_master_default_trigger_condition_values', 'SortOrder', '`SortOrder` int NOT NULL DEFAULT ''0''');
CALL _schema_sync_add_column('compl_master_default_trigger_conditions', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_master_default_trigger_conditions', 'ConfigId', '`ConfigId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_master_default_trigger_conditions', 'TriggerId', '`TriggerId` bigint NOT NULL COMMENT ''FK compl_ref_trigger''');
CALL _schema_sync_add_column('compl_master_default_trigger_conditions', 'TriggerRefTypeId', '`TriggerRefTypeId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_master_default_trigger_conditions', 'SortOrder', '`SortOrder` int NOT NULL DEFAULT ''0''');
CALL _schema_sync_add_column('compl_master_group_email', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_master_group_email', 'MasterId', '`MasterId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_master_group_email', 'GroupEmailId', '`GroupEmailId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_master_group_email', 'GroupType', '`GroupType` tinyint NOT NULL');
CALL _schema_sync_add_column('compl_master_group_email', 'CreatedDate', '`CreatedDate` datetime DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_master_group_email', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_master_hierarchies', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_master_hierarchies', 'MasterCode', '`MasterCode` varchar(50) NOT NULL');
CALL _schema_sync_add_column('compl_master_hierarchies', 'ParentCode', '`ParentCode` varchar(50) NOT NULL DEFAULT ''''');
CALL _schema_sync_add_column('compl_master_hierarchies', 'DisplayOrder', '`DisplayOrder` int NOT NULL DEFAULT ''0''');
CALL _schema_sync_add_column('compl_master_hierarchies', 'CreatedDate', '`CreatedDate` datetime DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_master_hierarchies', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_master_hierarchies', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_master_hierarchies', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_masters', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_masters', 'Code', '`Code` varchar(50) NOT NULL');
CALL _schema_sync_add_column('compl_masters', 'Name', '`Name` varchar(255) NOT NULL');
CALL _schema_sync_add_column('compl_masters', 'ValidFrom', '`ValidFrom` datetime NOT NULL');
CALL _schema_sync_add_column('compl_masters', 'ValidTo', '`ValidTo` datetime DEFAULT NULL');
CALL _schema_sync_add_column('compl_masters', 'NumDayAlert', '`NumDayAlert` int DEFAULT NULL');
CALL _schema_sync_add_column('compl_masters', 'Description', '`Description` varchar(500) DEFAULT NULL');
CALL _schema_sync_add_column('compl_masters', 'IsIndividual', '`IsIndividual` tinyint(1) DEFAULT ''0''');
CALL _schema_sync_add_column('compl_masters', 'IsDelete', '`IsDelete` tinyint(1) DEFAULT ''0''');
CALL _schema_sync_add_column('compl_masters', 'VersionNo', '`VersionNo` int DEFAULT ''1''');
CALL _schema_sync_add_column('compl_masters', 'ReplacedById', '`ReplacedById` bigint DEFAULT NULL');
CALL _schema_sync_add_column('compl_masters', 'DuplicateId', '`DuplicateId` bigint DEFAULT NULL');
CALL _schema_sync_add_column('compl_masters', 'CreatedDate', '`CreatedDate` datetime DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_masters', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_masters', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_masters', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_masters', 'AlertType', '`AlertType` tinyint DEFAULT ''0''');
CALL _schema_sync_add_column('compl_notifications', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_notifications', 'UserEmail', '`UserEmail` varchar(100) NOT NULL');
CALL _schema_sync_add_column('compl_notifications', 'Title', '`Title` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('compl_notifications', 'Message', '`Message` varchar(255) NOT NULL');
CALL _schema_sync_add_column('compl_notifications', 'Type', '`Type` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_notifications', 'RedirectType', '`RedirectType` enum(''Compliance'',''compl'') NOT NULL');
CALL _schema_sync_add_column('compl_notifications', 'RedirectId', '`RedirectId` int NOT NULL');
CALL _schema_sync_add_column('compl_notifications', 'IsRead', '`IsRead` tinyint(1) DEFAULT ''0''');
CALL _schema_sync_add_column('compl_notifications', 'CreatedDate', '`CreatedDate` datetime DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_notifications', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_notifications', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_notifications', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_ref_tracked_objects', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_ref_tracked_objects', 'RefTypeId', '`RefTypeId` bigint NOT NULL COMMENT ''FK to compl_reference_types''');
CALL _schema_sync_add_column('compl_ref_tracked_objects', 'TriggerId', '`TriggerId` bigint DEFAULT NULL COMMENT ''FK compl_ref_trigger''');
CALL _schema_sync_add_column('compl_ref_tracked_objects', 'Code', '`Code` varchar(100) DEFAULT NULL');
CALL _schema_sync_add_column('compl_ref_tracked_objects', 'Name', '`Name` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('compl_ref_tracked_objects', 'RefValue', '`RefValue` text');
CALL _schema_sync_add_column('compl_ref_tracked_objects', 'GroupValue', '`GroupValue` varchar(255) DEFAULT NULL COMMENT ''RSVNAttributeTypeValueAlls.GroupValue''');
CALL _schema_sync_add_column('compl_ref_tracked_objects', 'IsNew', '`IsNew` tinyint(1) NOT NULL DEFAULT ''1''');
CALL _schema_sync_add_column('compl_ref_tracked_objects', 'CreatedDate', '`CreatedDate` datetime DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_ref_tracked_objects', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_ref_tracked_objects', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_ref_tracked_objects', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_ref_trigger', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_ref_trigger', 'RefTypeId', '`RefTypeId` bigint NOT NULL COMMENT ''FK to compl_reference_types''');
CALL _schema_sync_add_column('compl_ref_trigger', 'Model365', '`Model365` varchar(100) DEFAULT NULL');
CALL _schema_sync_add_column('compl_ref_trigger', 'Filter365', '`Filter365` varchar(255) DEFAULT NULL COMMENT ''vd: Upholstery type "AttributeTypeRecId = 5637149831"''');
CALL _schema_sync_add_column('compl_ref_trigger', 'DisplayName', '`DisplayName` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('compl_ref_trigger', 'Description', '`Description` varchar(1500) DEFAULT NULL');
CALL _schema_sync_add_column('compl_ref_trigger', 'IsShow', '`IsShow` tinyint(1) NOT NULL DEFAULT ''1''');
CALL _schema_sync_add_column('compl_ref_trigger', 'SortOrder', '`SortOrder` int NOT NULL DEFAULT ''0''');
CALL _schema_sync_add_column('compl_ref_trigger', 'CreatedDate', '`CreatedDate` datetime DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_ref_trigger', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_ref_trigger', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_ref_trigger', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_reference_types', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_reference_types', 'Code', '`Code` varchar(20) DEFAULT NULL');
CALL _schema_sync_add_column('compl_reference_types', 'Name', '`Name` varchar(100) NOT NULL');
CALL _schema_sync_add_column('compl_reference_types', 'DisplayOrder', '`DisplayOrder` int DEFAULT NULL');
CALL _schema_sync_add_column('compl_reference_types', 'Model365', '`Model365` varchar(150) DEFAULT NULL');
CALL _schema_sync_add_column('compl_reference_types', 'IsActive', '`IsActive` tinyint(1) DEFAULT ''1''');
CALL _schema_sync_add_column('compl_reference_types', 'Description', '`Description` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('compl_reference_types', 'CreatedDate', '`CreatedDate` datetime DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_reference_types', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_reference_types', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_reference_types', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_reference_types', 'AllowIndividual', '`AllowIndividual` tinyint(1) DEFAULT ''1''');
CALL _schema_sync_add_column('compl_references', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_references', 'MasterId', '`MasterId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_references', 'ComplianceId', '`ComplianceId` bigint NOT NULL');
CALL _schema_sync_add_column('compl_references', 'ComplType', '`ComplType` tinyint NOT NULL DEFAULT ''0''');
CALL _schema_sync_add_column('compl_references', 'RefTypeId', '`RefTypeId` bigint DEFAULT NULL');
CALL _schema_sync_add_column('compl_references', 'RefTypeValue', '`RefTypeValue` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('compl_references', 'ValidFrom', '`ValidFrom` datetime DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_references', 'ValidTo', '`ValidTo` datetime DEFAULT NULL');
CALL _schema_sync_add_column('compl_sharepoint_files', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_sharepoint_files', 'FileId', '`FileId` varchar(255) NOT NULL');
CALL _schema_sync_add_column('compl_sharepoint_files', 'DriveId', '`DriveId` varchar(255) NOT NULL');
CALL _schema_sync_add_column('compl_sharepoint_files', 'Name', '`Name` varchar(1500) NOT NULL');
CALL _schema_sync_add_column('compl_sharepoint_files', 'WebUrl', '`WebUrl` text');
CALL _schema_sync_add_column('compl_sharepoint_files', 'DownloadUrl', '`DownloadUrl` text');
CALL _schema_sync_add_column('compl_sharepoint_files', 'MimeType', '`MimeType` varchar(100) DEFAULT NULL');
CALL _schema_sync_add_column('compl_sharepoint_files', 'Size', '`Size` bigint DEFAULT NULL');
CALL _schema_sync_add_column('compl_sharepoint_files', 'Etag', '`Etag` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('compl_sharepoint_files', 'Ctag', '`Ctag` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('compl_sharepoint_files', 'CreatedBy', '`CreatedBy` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('compl_sharepoint_files', 'CreatedDatetime', '`CreatedDatetime` datetime DEFAULT NULL');
CALL _schema_sync_add_column('compl_sharepoint_files', 'LastModifiedBy', '`LastModifiedBy` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('compl_sharepoint_files', 'LastModifiedDatetime', '`LastModifiedDatetime` datetime DEFAULT NULL');
CALL _schema_sync_add_column('compl_sharepoint_files', 'ParentId', '`ParentId` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('compl_sharepoint_files', 'ParentName', '`ParentName` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('compl_sharepoint_files', 'ParentPath', '`ParentPath` text');
CALL _schema_sync_add_column('compl_sharepoint_files', 'FolderSharePoint', '`FolderSharePoint` text');
CALL _schema_sync_add_column('compl_sharepoint_files', 'RawJson', '`RawJson` json DEFAULT NULL');
CALL _schema_sync_add_column('compl_sharepoint_files', 'CreatedDate', '`CreatedDate` datetime DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_sharepoint_files', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_sharepoint_files', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_sharepoint_files', 'IsMapped', '`IsMapped` tinyint DEFAULT ''0''');
CALL _schema_sync_add_column('compl_so_missing', 'MasterId', '`MasterId` bigint NOT NULL DEFAULT ''0''');
CALL _schema_sync_add_column('compl_so_missing', 'MasterCode', '`MasterCode` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_so_missing', 'MasterName', '`MasterName` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('compl_so_missing', 'MasterValidFrom', '`MasterValidFrom` datetime DEFAULT NULL');
CALL _schema_sync_add_column('compl_so_missing', 'MasterValidTo', '`MasterValidTo` datetime DEFAULT NULL');
CALL _schema_sync_add_column('compl_so_missing', 'MasterNumDayAlert', '`MasterNumDayAlert` int DEFAULT NULL');
CALL _schema_sync_add_column('compl_so_missing', 'MasterDescription', '`MasterDescription` varchar(500) DEFAULT NULL');
CALL _schema_sync_add_column('compl_so_missing', 'MasterVersionNo', '`MasterVersionNo` int DEFAULT NULL');
CALL _schema_sync_add_column('compl_so_missing', 'Status', '`Status` varchar(7) NOT NULL DEFAULT ''''');
CALL _schema_sync_add_column('compl_so_missing', 'Id', '`Id` bigint NOT NULL DEFAULT ''0''');
CALL _schema_sync_add_column('compl_so_missing', 'Code', '`Code` varchar(100) NOT NULL DEFAULT ''''');
CALL _schema_sync_add_column('compl_so_missing', 'Name', '`Name` varchar(511) NOT NULL DEFAULT ''''');
CALL _schema_sync_add_column('compl_so_missing', 'FileId', '`FileId` varchar(255) NOT NULL DEFAULT ''''');
CALL _schema_sync_add_column('compl_so_missing', 'ValidFrom', '`ValidFrom` datetime DEFAULT NULL');
CALL _schema_sync_add_column('compl_so_missing', 'ValidTo', '`ValidTo` datetime DEFAULT NULL');
CALL _schema_sync_add_column('compl_so_missing', 'NumDayAlert', '`NumDayAlert` int DEFAULT NULL');
CALL _schema_sync_add_column('compl_so_missing', 'VersionNo', '`VersionNo` int DEFAULT NULL');
CALL _schema_sync_add_column('compl_so_missing', 'ReplacedById', '`ReplacedById` bigint DEFAULT NULL');
CALL _schema_sync_add_column('compl_so_missing', 'Description', '`Description` longtext NOT NULL');
CALL _schema_sync_add_column('compl_so_missing', 'AlertGroupsJson', '`AlertGroupsJson` json DEFAULT NULL');
CALL _schema_sync_add_column('compl_so_missing', 'ResponsibleGroupsJson', '`ResponsibleGroupsJson` json DEFAULT NULL');
CALL _schema_sync_add_column('compl_so_missing', 'ConditionsJson', '`ConditionsJson` json DEFAULT NULL');
CALL _schema_sync_add_column('compl_so_missing', 'MappedRefTypeId', '`MappedRefTypeId` bigint unsigned DEFAULT NULL');
CALL _schema_sync_add_column('compl_so_missing', 'MappedRefTypeCode', '`MappedRefTypeCode` varchar(150) DEFAULT NULL');
CALL _schema_sync_add_column('compl_so_missing', 'MappedRefTypeName', '`MappedRefTypeName` varchar(300) DEFAULT NULL');
CALL _schema_sync_add_column('compl_so_missing', 'MappedInputValue', '`MappedInputValue` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('compl_so_missing', 'SalesId', '`SalesId` varchar(45) DEFAULT NULL');
CALL _schema_sync_add_column('compl_summary_so', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_summary_so', 'SalesOrder', '`SalesOrder` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_summary_so', 'CusCode', '`CusCode` varchar(100) DEFAULT NULL');
CALL _schema_sync_add_column('compl_summary_so', 'InvoiceDate', '`InvoiceDate` datetime DEFAULT NULL');
CALL _schema_sync_add_column('compl_summary_so', 'TotalApplied', '`TotalApplied` int DEFAULT NULL');
CALL _schema_sync_add_column('compl_summary_so', 'TotalMissing', '`TotalMissing` int DEFAULT NULL');
CALL _schema_sync_add_column('compl_summary_so', 'TotalOverdue', '`TotalOverdue` int DEFAULT NULL');
CALL _schema_sync_add_column('compl_summary_so', 'TotalCompliances', '`TotalCompliances` int DEFAULT NULL');
CALL _schema_sync_add_column('compl_summary_so', 'BomStatus', '`BomStatus` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_summary_so', 'RawJson', '`RawJson` json DEFAULT NULL');
CALL _schema_sync_add_column('compl_summary_so', 'CreatedDate', '`CreatedDate` datetime DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_summary_so', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_summary_so', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_summary_so', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_summary_so', 'MissingMasterIds', '`MissingMasterIds` text');
CALL _schema_sync_add_column('compl_summary_so', 'OverdueMasterIds', '`OverdueMasterIds` text');
CALL _schema_sync_add_column('compl_summary_so', 'ResponsibleEmails', '`ResponsibleEmails` text');
CALL _schema_sync_add_column('compl_summary_so', 'AlertEmails', '`AlertEmails` text');
CALL _schema_sync_add_column('compl_sync_sales_line', 'Id', '`Id` bigint unsigned NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_sync_sales_line', 'SalesId', '`SalesId` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_sync_sales_line', 'SalesStatus', '`SalesStatus` varchar(50) NOT NULL');
CALL _schema_sync_add_column('compl_sync_sales_line', 'ProductCode', '`ProductCode` varchar(50) NOT NULL');
CALL _schema_sync_add_column('compl_sync_sales_line', 'ConfigId', '`ConfigId` varchar(20) NOT NULL');
CALL _schema_sync_add_column('compl_sync_sales_line', 'ProductName', '`ProductName` varchar(250) NOT NULL');
CALL _schema_sync_add_column('compl_sync_sales_line', 'ProductDescription', '`ProductDescription` varchar(250) NOT NULL');
CALL _schema_sync_add_column('compl_sync_sales_line', 'ProductType', '`ProductType` varchar(100) NOT NULL');
CALL _schema_sync_add_column('compl_sync_sales_line', 'ProductRange', '`ProductRange` varchar(100) NOT NULL');
CALL _schema_sync_add_column('compl_sync_sales_line', 'CreatedDate', '`CreatedDate` datetime NOT NULL');
CALL _schema_sync_add_column('compl_sync_variant_attributes', 'Id', '`Id` bigint unsigned NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_sync_variant_attributes', 'ProductCode', '`ProductCode` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('compl_sync_variant_attributes', 'ConfigId', '`ConfigId` varchar(20) NOT NULL');
CALL _schema_sync_add_column('compl_sync_variant_attributes', 'GroupId', '`GroupId` varchar(50) NOT NULL');
CALL _schema_sync_add_column('compl_sync_variant_attributes', 'GroupValue', '`GroupValue` varchar(50) NOT NULL');
CALL _schema_sync_add_column('compl_sync_variant_attributes', 'AttributeType', '`AttributeType` bigint NOT NULL');
CALL _schema_sync_add_column('compl_sync_variant_attributes', 'AttributeTypeName', '`AttributeTypeName` varchar(150) NOT NULL');
CALL _schema_sync_add_column('compl_sync_variant_attributes', 'AttributeValue', '`AttributeValue` bigint NOT NULL');
CALL _schema_sync_add_column('compl_sync_variant_attributes', 'AttributeValueName', '`AttributeValueName` varchar(150) NOT NULL');
CALL _schema_sync_add_column('compl_sync_variant_attributes', 'CreatedDate', '`CreatedDate` datetime NOT NULL');
CALL _schema_sync_add_column('compl_user_grid_preference', 'Id', '`Id` bigint NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('compl_user_grid_preference', 'UserEmail', '`UserEmail` varchar(320) NOT NULL COMMENT ''User email - references compl_user.Email''');
CALL _schema_sync_add_column('compl_user_grid_preference', 'PageId', '`PageId` varchar(100) NOT NULL COMMENT ''Page identifier, e.g. pipeline, customer, contact''');
CALL _schema_sync_add_column('compl_user_grid_preference', 'GridId', '`GridId` varchar(100) NOT NULL COMMENT ''Grid identifier in page scope, e.g. Customer, Pipeline, contacts''');
CALL _schema_sync_add_column('compl_user_grid_preference', 'ViewName', '`ViewName` varchar(100) NOT NULL DEFAULT ''Default'' COMMENT ''Named column view under page/grid scope''');
CALL _schema_sync_add_column('compl_user_grid_preference', 'IsDefault', '`IsDefault` tinyint(1) NOT NULL DEFAULT ''0'' COMMENT ''Default selected view for page/grid''');
CALL _schema_sync_add_column('compl_user_grid_preference', 'ColumnVisibilityJson', '`ColumnVisibilityJson` longtext NOT NULL COMMENT ''JSON object storing MUI DataGrid column visibility model''');
CALL _schema_sync_add_column('compl_user_grid_preference', 'CreatedOn', '`CreatedOn` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('compl_user_grid_preference', 'UpdatedOn', '`UpdatedOn` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP');
CALL _schema_sync_add_column('eutr_documents', 'Id', '`Id` bigint unsigned NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('eutr_documents', 'Name', '`Name` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_documents', 'FileId', '`FileId` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_documents', 'ValidFrom', '`ValidFrom` date DEFAULT NULL');
CALL _schema_sync_add_column('eutr_documents', 'ValidTo', '`ValidTo` date DEFAULT NULL');
CALL _schema_sync_add_column('eutr_documents', 'Invoice', '`Invoice` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_documents', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_documents', 'CreatedDate', '`CreatedDate` datetime DEFAULT NULL');
CALL _schema_sync_add_column('eutr_documents', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_documents', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT NULL');
CALL _schema_sync_add_column('eutr_master_documents', 'Id', '`Id` bigint unsigned NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('eutr_master_documents', 'StepId', '`StepId` bigint unsigned DEFAULT NULL');
CALL _schema_sync_add_column('eutr_master_documents', 'Prefix', '`Prefix` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_master_documents', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_master_documents', 'CreatedDate', '`CreatedDate` datetime DEFAULT NULL');
CALL _schema_sync_add_column('eutr_master_documents', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_master_documents', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT NULL');
CALL _schema_sync_add_column('eutr_purchase_attachments', 'Id', '`Id` int unsigned NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('eutr_purchase_attachments', 'SalesId', '`SalesId` varchar(50) NOT NULL');
CALL _schema_sync_add_column('eutr_purchase_attachments', 'PurchId', '`PurchId` varchar(50) NOT NULL');
CALL _schema_sync_add_column('eutr_purchase_attachments', 'TemplateCode', '`TemplateCode` varchar(50) NOT NULL');
CALL _schema_sync_add_column('eutr_purchase_attachments', 'CreatedBy', '`CreatedBy` varchar(50) NOT NULL');
CALL _schema_sync_add_column('eutr_purchase_attachments', 'CreatedDate', '`CreatedDate` datetime NOT NULL');
CALL _schema_sync_add_column('eutr_purchase_attachments', 'UpdatedBy', '`UpdatedBy` varchar(50) NOT NULL');
CALL _schema_sync_add_column('eutr_purchase_attachments', 'UpdatedDate', '`UpdatedDate` datetime NOT NULL');
CALL _schema_sync_add_column('eutr_purchase_missing', 'Id', '`Id` int unsigned NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('eutr_purchase_missing', 'PurchId', '`PurchId` varchar(50) NOT NULL');
CALL _schema_sync_add_column('eutr_purchase_missing', 'VendorCode', '`VendorCode` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_purchase_missing', 'VendorName', '`VendorName` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_purchase_missing', 'TemplateId', '`TemplateId` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_purchase_missing', 'Note', '`Note` text NOT NULL');
CALL _schema_sync_add_column('eutr_purchase_missing', 'AlertForGroupId', '`AlertForGroupId` bigint unsigned DEFAULT NULL');
CALL _schema_sync_add_column('eutr_reference_details', 'Id', '`Id` bigint unsigned NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('eutr_reference_details', 'RefId', '`RefId` bigint unsigned DEFAULT NULL');
CALL _schema_sync_add_column('eutr_reference_details', 'ConditionType', '`ConditionType` bigint NOT NULL DEFAULT ''0''');
CALL _schema_sync_add_column('eutr_reference_details', 'ConditionValue', '`ConditionValue` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_reference_details', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_reference_details', 'CreatedDate', '`CreatedDate` datetime DEFAULT NULL');
CALL _schema_sync_add_column('eutr_reference_details', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_reference_details', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT NULL');
CALL _schema_sync_add_column('eutr_reference_type_details', 'Id', '`Id` bigint unsigned NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('eutr_reference_type_details', 'StepId', '`StepId` bigint unsigned DEFAULT NULL');
CALL _schema_sync_add_column('eutr_reference_type_details', 'TypeId', '`TypeId` bigint unsigned DEFAULT NULL');
CALL _schema_sync_add_column('eutr_reference_type_details', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_reference_type_details', 'CreatedDate', '`CreatedDate` datetime DEFAULT NULL');
CALL _schema_sync_add_column('eutr_reference_type_details', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_reference_type_details', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT NULL');
CALL _schema_sync_add_column('eutr_reference_types', 'Id', '`Id` bigint unsigned NOT NULL');
CALL _schema_sync_add_column('eutr_reference_types', 'Name', '`Name` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_reference_types', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_reference_types', 'CreatedDate', '`CreatedDate` datetime DEFAULT NULL');
CALL _schema_sync_add_column('eutr_reference_types', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_reference_types', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT NULL');
CALL _schema_sync_add_column('eutr_references', 'Id', '`Id` bigint unsigned NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('eutr_references', 'RefId', '`RefId` bigint unsigned DEFAULT NULL');
CALL _schema_sync_add_column('eutr_references', 'StepId', '`StepId` bigint DEFAULT NULL');
CALL _schema_sync_add_column('eutr_references', 'DocumentId', '`DocumentId` bigint unsigned DEFAULT NULL');
CALL _schema_sync_add_column('eutr_references', 'RefType', '`RefType` bigint unsigned DEFAULT NULL');
CALL _schema_sync_add_column('eutr_references', 'RefValue', '`RefValue` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_references', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_references', 'CreatedDate', '`CreatedDate` datetime DEFAULT NULL');
CALL _schema_sync_add_column('eutr_references', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_references', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT NULL');
CALL _schema_sync_add_column('eutr_steps', 'Id', '`Id` bigint unsigned NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('eutr_steps', 'Name', '`Name` varchar(255) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_steps', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_steps', 'CreatedDate', '`CreatedDate` datetime DEFAULT NULL');
CALL _schema_sync_add_column('eutr_steps', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_steps', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT NULL');
CALL _schema_sync_add_column('eutr_template_details', 'Id', '`Id` bigint unsigned NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('eutr_template_details', 'TemplateId', '`TemplateId` bigint unsigned DEFAULT NULL');
CALL _schema_sync_add_column('eutr_template_details', 'StepId', '`StepId` bigint unsigned DEFAULT NULL');
CALL _schema_sync_add_column('eutr_template_details', 'RequirementType', '`RequirementType` tinyint DEFAULT ''0''');
CALL _schema_sync_add_column('eutr_template_details', 'DisplayOrder', '`DisplayOrder` int DEFAULT ''0''');
CALL _schema_sync_add_column('eutr_template_details', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_template_details', 'CreatedDate', '`CreatedDate` datetime DEFAULT NULL');
CALL _schema_sync_add_column('eutr_template_details', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_template_details', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT NULL');
CALL _schema_sync_add_column('eutr_template_details', 'TakeFrom', '`TakeFrom` bigint unsigned DEFAULT NULL');
CALL _schema_sync_add_column('eutr_template_details', 'ParentId', '`ParentId` bigint DEFAULT ''0''');
CALL _schema_sync_add_column('eutr_template_references', 'Id', '`Id` bigint unsigned NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('eutr_template_references', 'TemplateId', '`TemplateId` bigint unsigned NOT NULL');
CALL _schema_sync_add_column('eutr_template_references', 'VendorCode', '`VendorCode` varchar(50) NOT NULL');
CALL _schema_sync_add_column('eutr_template_references', 'FromDate', '`FromDate` date NOT NULL');
CALL _schema_sync_add_column('eutr_template_references', 'ToDate', '`ToDate` date NOT NULL');
CALL _schema_sync_add_column('eutr_template_references', 'CreatedBy', '`CreatedBy` varchar(50) NOT NULL');
CALL _schema_sync_add_column('eutr_template_references', 'CreatedDate', '`CreatedDate` datetime NOT NULL');
CALL _schema_sync_add_column('eutr_template_references', 'UpdatedBy', '`UpdatedBy` varchar(50) NOT NULL');
CALL _schema_sync_add_column('eutr_template_references', 'UpdatedDate', '`UpdatedDate` datetime NOT NULL');
CALL _schema_sync_add_column('eutr_templates', 'Id', '`Id` bigint unsigned NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('eutr_templates', 'Code', '`Code` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_templates', 'Name', '`Name` varchar(400) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_templates', 'IsDefault', '`IsDefault` tinyint DEFAULT ''0''');
CALL _schema_sync_add_column('eutr_templates', 'VersionId', '`VersionId` tinyint DEFAULT ''1''');
CALL _schema_sync_add_column('eutr_templates', 'Status', '`Status` tinyint DEFAULT ''0''');
CALL _schema_sync_add_column('eutr_templates', 'CreatedBy', '`CreatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_templates', 'CreatedDate', '`CreatedDate` datetime DEFAULT NULL');
CALL _schema_sync_add_column('eutr_templates', 'UpdatedBy', '`UpdatedBy` varchar(50) DEFAULT NULL');
CALL _schema_sync_add_column('eutr_templates', 'UpdatedDate', '`UpdatedDate` datetime DEFAULT NULL');
CALL _schema_sync_add_column('eutr_templates', 'AlertFor', '`AlertFor` tinyint DEFAULT NULL');
CALL _schema_sync_add_column('eutr_templates', 'IsDeleted', '`IsDeleted` tinyint DEFAULT ''0''');
CALL _schema_sync_add_column('eutr_templates', 'IsHide', '`IsHide` tinyint DEFAULT ''0''');
CALL _schema_sync_add_column('hf_AggregatedCounter', 'Id', '`Id` int NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('hf_AggregatedCounter', 'Key', '`Key` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL');
CALL _schema_sync_add_column('hf_AggregatedCounter', 'Value', '`Value` int NOT NULL');
CALL _schema_sync_add_column('hf_AggregatedCounter', 'ExpireAt', '`ExpireAt` datetime DEFAULT NULL');
CALL _schema_sync_add_column('hf_Counter', 'Id', '`Id` int NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('hf_Counter', 'Key', '`Key` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL');
CALL _schema_sync_add_column('hf_Counter', 'Value', '`Value` int NOT NULL');
CALL _schema_sync_add_column('hf_Counter', 'ExpireAt', '`ExpireAt` datetime DEFAULT NULL');
CALL _schema_sync_add_column('hf_DistributedLock', 'Resource', '`Resource` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL');
CALL _schema_sync_add_column('hf_DistributedLock', 'CreatedAt', '`CreatedAt` datetime(6) NOT NULL');
CALL _schema_sync_add_column('hf_Hash', 'Id', '`Id` int NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('hf_Hash', 'Key', '`Key` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL');
CALL _schema_sync_add_column('hf_Hash', 'Field', '`Field` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL');
CALL _schema_sync_add_column('hf_Hash', 'Value', '`Value` longtext');
CALL _schema_sync_add_column('hf_Hash', 'ExpireAt', '`ExpireAt` datetime(6) DEFAULT NULL');
CALL _schema_sync_add_column('hf_Job', 'Id', '`Id` int NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('hf_Job', 'StateId', '`StateId` int DEFAULT NULL');
CALL _schema_sync_add_column('hf_Job', 'StateName', '`StateName` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL');
CALL _schema_sync_add_column('hf_Job', 'InvocationData', '`InvocationData` longtext NOT NULL');
CALL _schema_sync_add_column('hf_Job', 'Arguments', '`Arguments` longtext NOT NULL');
CALL _schema_sync_add_column('hf_Job', 'CreatedAt', '`CreatedAt` datetime(6) NOT NULL');
CALL _schema_sync_add_column('hf_Job', 'ExpireAt', '`ExpireAt` datetime(6) DEFAULT NULL');
CALL _schema_sync_add_column('hf_JobParameter', 'Id', '`Id` int NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('hf_JobParameter', 'JobId', '`JobId` int NOT NULL');
CALL _schema_sync_add_column('hf_JobParameter', 'Name', '`Name` varchar(40) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL');
CALL _schema_sync_add_column('hf_JobParameter', 'Value', '`Value` longtext');
CALL _schema_sync_add_column('hf_JobQueue', 'Id', '`Id` int NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('hf_JobQueue', 'JobId', '`JobId` int NOT NULL');
CALL _schema_sync_add_column('hf_JobQueue', 'FetchedAt', '`FetchedAt` datetime(6) DEFAULT NULL');
CALL _schema_sync_add_column('hf_JobQueue', 'Queue', '`Queue` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL');
CALL _schema_sync_add_column('hf_JobQueue', 'FetchToken', '`FetchToken` varchar(36) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL');
CALL _schema_sync_add_column('hf_JobState', 'Id', '`Id` int NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('hf_JobState', 'JobId', '`JobId` int NOT NULL');
CALL _schema_sync_add_column('hf_JobState', 'CreatedAt', '`CreatedAt` datetime(6) NOT NULL');
CALL _schema_sync_add_column('hf_JobState', 'Name', '`Name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL');
CALL _schema_sync_add_column('hf_JobState', 'Reason', '`Reason` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL');
CALL _schema_sync_add_column('hf_JobState', 'Data', '`Data` longtext');
CALL _schema_sync_add_column('hf_List', 'Id', '`Id` int NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('hf_List', 'Key', '`Key` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL');
CALL _schema_sync_add_column('hf_List', 'Value', '`Value` longtext');
CALL _schema_sync_add_column('hf_List', 'ExpireAt', '`ExpireAt` datetime(6) DEFAULT NULL');
CALL _schema_sync_add_column('hf_Server', 'Id', '`Id` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL');
CALL _schema_sync_add_column('hf_Server', 'Data', '`Data` longtext NOT NULL');
CALL _schema_sync_add_column('hf_Server', 'LastHeartbeat', '`LastHeartbeat` datetime(6) DEFAULT NULL');
CALL _schema_sync_add_column('hf_Set', 'Id', '`Id` int NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('hf_Set', 'Key', '`Key` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL');
CALL _schema_sync_add_column('hf_Set', 'Value', '`Value` varchar(256) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL');
CALL _schema_sync_add_column('hf_Set', 'Score', '`Score` float NOT NULL');
CALL _schema_sync_add_column('hf_Set', 'ExpireAt', '`ExpireAt` datetime DEFAULT NULL');
CALL _schema_sync_add_column('hf_State', 'Id', '`Id` int NOT NULL AUTO_INCREMENT');
CALL _schema_sync_add_column('hf_State', 'JobId', '`JobId` int NOT NULL');
CALL _schema_sync_add_column('hf_State', 'Name', '`Name` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL');
CALL _schema_sync_add_column('hf_State', 'Reason', '`Reason` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci DEFAULT NULL');
CALL _schema_sync_add_column('hf_State', 'CreatedAt', '`CreatedAt` datetime(6) NOT NULL');
CALL _schema_sync_add_column('hf_State', 'Data', '`Data` longtext');


-- Add missing primary and secondary indexes.

CALL _schema_sync_add_index('compl_code_sequences', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_code_sequences', 'Prefix', 'UNIQUE KEY `Prefix` (`Prefix`)');
CALL _schema_sync_add_index('compl_compliance_group_email', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_compliance_group_email', 'UK_Compliance_Group_Type', 'UNIQUE KEY `UK_Compliance_Group_Type` (`ComplianceId`,`GroupEmailId`,`GroupType`)');
CALL _schema_sync_add_index('compl_compliance_group_email', 'FK_GroupEmail', 'KEY `FK_GroupEmail` (`GroupEmailId`)');
CALL _schema_sync_add_index('compl_compliances', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_compliances', 'fk_compliance_document_type', 'KEY `fk_compliance_document_type` (`DocumentTypeId`)');
CALL _schema_sync_add_index('compl_compliances', 'idx_compl_compliances_validity', 'KEY `idx_compl_compliances_validity` (`ValidFrom`,`ValidTo`)');
CALL _schema_sync_add_index('compl_compliances', 'idx_code_version', 'KEY `idx_code_version` (`Code`,`VersionNo`)');
CALL _schema_sync_add_index('compl_compliances', 'ft_search_compliances_idx', 'FULLTEXT KEY `ft_search_compliances_idx` (`Name`,`Code`,`Description`)');
CALL _schema_sync_add_index('compl_config', 'PRIMARY', 'PRIMARY KEY (`ConfigKey`)');
CALL _schema_sync_add_index('compl_country_group_members', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_country_group_members', 'uq_group_country', 'UNIQUE KEY `uq_group_country` (`GroupId`,`CountryCode`)');
CALL _schema_sync_add_index('compl_country_group_members', 'idx_country_code', 'KEY `idx_country_code` (`CountryCode`)');
CALL _schema_sync_add_index('compl_country_groups', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_country_groups', 'uq_country_group_code', 'UNIQUE KEY `uq_country_group_code` (`Code`)');
CALL _schema_sync_add_index('compl_document_type', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_group_email', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_group_email_detail', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_group_email_detail', 'compl_group_email_detail_ibfk_1', 'KEY `compl_group_email_detail_ibfk_1` (`GroupEmailId`)');
CALL _schema_sync_add_index('compl_group_email_detail', 'idx_group_email_detail_active', 'KEY `idx_group_email_detail_active` (`GroupEmailId`,`IsActive`,`ResponseEmail`)');
CALL _schema_sync_add_index('compl_history', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_job_schedule_configs', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_job_schedule_configs', 'JobId', 'UNIQUE KEY `JobId` (`JobId`)');
CALL _schema_sync_add_index('compl_job_schedule_configs', 'UQ_compl_job_schedule_configs_JobId', 'UNIQUE KEY `UQ_compl_job_schedule_configs_JobId` (`JobId`)');
CALL _schema_sync_add_index('compl_master_condition_values', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_master_condition_values', 'idx_value', 'KEY `idx_value` (`RefTypeValue`)');
CALL _schema_sync_add_index('compl_master_condition_values', 'idx_master_condition_values', 'KEY `idx_master_condition_values` (`ConditionId`)');
CALL _schema_sync_add_index('compl_master_conditions', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_master_conditions', 'fk_compl_master_conditions_reference_type', 'KEY `fk_compl_master_conditions_reference_type` (`RefTypeId`)');
CALL _schema_sync_add_index('compl_master_conditions', 'idx_master_conditions_masterid', 'KEY `idx_master_conditions_masterid` (`MasterId`,`ComplType`)');
CALL _schema_sync_add_index('compl_master_default_configs', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_master_default_configs', 'uq_mdc_code', 'UNIQUE KEY `uq_mdc_code` (`Code`)');
CALL _schema_sync_add_index('compl_master_default_configs', 'fk_mdc_trigger_ref', 'KEY `fk_mdc_trigger_ref` (`TriggerRefTypeId`)');
CALL _schema_sync_add_index('compl_master_default_configs', 'fk_mdc_trigger', 'KEY `fk_mdc_trigger` (`TriggerId`)');
CALL _schema_sync_add_index('compl_master_default_logs', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_master_default_logs', 'idx_log_config', 'KEY `idx_log_config` (`ConfigId`)');
CALL _schema_sync_add_index('compl_master_default_logs', 'idx_log_tracked', 'KEY `idx_log_tracked` (`TrackedObjectId`)');
CALL _schema_sync_add_index('compl_master_default_logs', 'idx_log_status', 'KEY `idx_log_status` (`Status`,`ProcessedAt`)');
CALL _schema_sync_add_index('compl_master_default_template_condition_values', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_master_default_template_condition_values', 'fk_tcv_condition', 'KEY `fk_tcv_condition` (`ConditionId`)');
CALL _schema_sync_add_index('compl_master_default_template_conditions', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_master_default_template_conditions', 'fk_tc_template', 'KEY `fk_tc_template` (`TemplateId`)');
CALL _schema_sync_add_index('compl_master_default_template_conditions', 'fk_tc_ref_type', 'KEY `fk_tc_ref_type` (`RefTypeId`)');
CALL _schema_sync_add_index('compl_master_default_template_group_email', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_master_default_template_group_email', 'UK_Master_Default_Group_Type', 'UNIQUE KEY `UK_Master_Default_Group_Type` (`TemplateId`,`GroupEmailId`,`GroupType`)');
CALL _schema_sync_add_index('compl_master_default_template_group_email', 'FK_Master_Default_GroupEmail', 'KEY `FK_Master_Default_GroupEmail` (`GroupEmailId`)');
CALL _schema_sync_add_index('compl_master_default_template_group_email', 'idx_master_default_group_email_composite', 'KEY `idx_master_default_group_email_composite` (`TemplateId`,`GroupType`,`GroupEmailId`)');
CALL _schema_sync_add_index('compl_master_default_templates', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_master_default_templates', 'fk_tmpl_config', 'KEY `fk_tmpl_config` (`ConfigId`)');
CALL _schema_sync_add_index('compl_master_default_trigger_condition_values', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_master_default_trigger_condition_values', 'idx_mdtcv_condition', 'KEY `idx_mdtcv_condition` (`ConditionId`,`SortOrder`)');
CALL _schema_sync_add_index('compl_master_default_trigger_condition_values', 'idx_mdtcv_value', 'KEY `idx_mdtcv_value` (`RefTypeValue`)');
CALL _schema_sync_add_index('compl_master_default_trigger_conditions', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_master_default_trigger_conditions', 'idx_mdtc_config', 'KEY `idx_mdtc_config` (`ConfigId`,`SortOrder`)');
CALL _schema_sync_add_index('compl_master_default_trigger_conditions', 'idx_mdtc_trigger', 'KEY `idx_mdtc_trigger` (`TriggerId`,`TriggerRefTypeId`)');
CALL _schema_sync_add_index('compl_master_default_trigger_conditions', 'fk_mdtc_trigger_ref', 'KEY `fk_mdtc_trigger_ref` (`TriggerRefTypeId`)');
CALL _schema_sync_add_index('compl_master_group_email', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_master_group_email', 'UK_Master_Group_Type', 'UNIQUE KEY `UK_Master_Group_Type` (`MasterId`,`GroupEmailId`,`GroupType`)');
CALL _schema_sync_add_index('compl_master_group_email', 'FK_Master_GroupEmail', 'KEY `FK_Master_GroupEmail` (`GroupEmailId`)');
CALL _schema_sync_add_index('compl_master_group_email', 'idx_master_group_email_composite', 'KEY `idx_master_group_email_composite` (`MasterId`,`GroupType`,`GroupEmailId`)');
CALL _schema_sync_add_index('compl_master_hierarchies', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_master_hierarchies', 'uq_compl_master_hierarchy', 'UNIQUE KEY `uq_compl_master_hierarchy` (`MasterCode`,`ParentCode`)');
CALL _schema_sync_add_index('compl_master_hierarchies', 'idx_compl_master_hierarchy_parent', 'KEY `idx_compl_master_hierarchy_parent` (`ParentCode`)');
CALL _schema_sync_add_index('compl_masters', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_masters', 'uq_compl_master_code', 'UNIQUE KEY `uq_compl_master_code` (`Code`,`VersionNo`)');
CALL _schema_sync_add_index('compl_masters', 'idx_masters_validto', 'KEY `idx_masters_validto` (`ValidTo`)');
CALL _schema_sync_add_index('compl_masters', 'idx_masters_createdby', 'KEY `idx_masters_createdby` (`CreatedBy`)');
CALL _schema_sync_add_index('compl_masters', 'ft_search_master_idx', 'FULLTEXT KEY `ft_search_master_idx` (`Name`,`Code`,`Description`)');
CALL _schema_sync_add_index('compl_masters', 'ft_master_name_code', 'FULLTEXT KEY `ft_master_name_code` (`Name`,`Code`)');
CALL _schema_sync_add_index('compl_notifications', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_notifications', 'idx_user_email', 'KEY `idx_user_email` (`UserEmail`)');
CALL _schema_sync_add_index('compl_notifications', 'idx_redirect_type', 'KEY `idx_redirect_type` (`RedirectType`)');
CALL _schema_sync_add_index('compl_ref_tracked_objects', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_ref_tracked_objects', 'uq_tracked_reftype_code', 'UNIQUE KEY `uq_tracked_reftype_code` (`RefTypeId`,`Code`)');
CALL _schema_sync_add_index('compl_ref_tracked_objects', 'idx_tracked_is_new', 'KEY `idx_tracked_is_new` (`IsNew`,`RefTypeId`)');
CALL _schema_sync_add_index('compl_ref_tracked_objects', 'idx_tracked_trigger', 'KEY `idx_tracked_trigger` (`TriggerId`)');
CALL _schema_sync_add_index('compl_ref_trigger', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_ref_trigger', 'uq_compl_ref_trigger', 'UNIQUE KEY `uq_compl_ref_trigger` (`RefTypeId`,`Model365`,`Filter365`)');
CALL _schema_sync_add_index('compl_reference_types', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_reference_types', 'idx_active', 'KEY `idx_active` (`IsActive`)');
CALL _schema_sync_add_index('compl_references', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_references', 'uq_compl_ref_master_ref', 'UNIQUE KEY `uq_compl_ref_master_ref` (`MasterId`,`ComplianceId`,`RefTypeId`,`RefTypeValue`)');
CALL _schema_sync_add_index('compl_references', 'fk_compl_references_compliance', 'KEY `fk_compl_references_compliance` (`ComplianceId`)');
CALL _schema_sync_add_index('compl_references', 'fk_compl_references_reference_type', 'KEY `fk_compl_references_reference_type` (`RefTypeId`)');
CALL _schema_sync_add_index('compl_references', 'idx_references_masterid', 'KEY `idx_references_masterid` (`MasterId`,`RefTypeId`,`RefTypeValue`,`ValidTo`)');
CALL _schema_sync_add_index('compl_sharepoint_files', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_sharepoint_files', 'uq_sharepoint_item', 'UNIQUE KEY `uq_sharepoint_item` (`FileId`,`DriveId`)');
CALL _schema_sync_add_index('compl_summary_so', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_sync_sales_line', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_sync_sales_line', 'compl_sales_line_salesid_index', 'KEY `compl_sales_line_salesid_index` (`SalesId`)');
CALL _schema_sync_add_index('compl_sync_sales_line', 'compl_sales_line_productcode_index', 'KEY `compl_sales_line_productcode_index` (`ProductCode`)');
CALL _schema_sync_add_index('compl_sync_sales_line', 'compl_sales_line_configid_index', 'KEY `compl_sales_line_configid_index` (`ConfigId`)');
CALL _schema_sync_add_index('compl_sync_sales_line', 'compl_sales_line_producttype_index', 'KEY `compl_sales_line_producttype_index` (`ProductType`)');
CALL _schema_sync_add_index('compl_sync_sales_line', 'compl_sales_line_productrange_index', 'KEY `compl_sales_line_productrange_index` (`ProductRange`)');
CALL _schema_sync_add_index('compl_sync_variant_attributes', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_sync_variant_attributes', 'compl_variant_attributes_productcode_index', 'KEY `compl_variant_attributes_productcode_index` (`ProductCode`)');
CALL _schema_sync_add_index('compl_sync_variant_attributes', 'compl_variant_attributes_configid_index', 'KEY `compl_variant_attributes_configid_index` (`ConfigId`)');
CALL _schema_sync_add_index('compl_sync_variant_attributes', 'compl_variant_attributes_attributetype_index', 'KEY `compl_variant_attributes_attributetype_index` (`AttributeType`)');
CALL _schema_sync_add_index('compl_sync_variant_attributes', 'compl_variant_attributes_attributevalue_index', 'KEY `compl_variant_attributes_attributevalue_index` (`AttributeValue`)');
CALL _schema_sync_add_index('compl_user_grid_preference', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('compl_user_grid_preference', 'uq_user_page_grid_view', 'UNIQUE KEY `uq_user_page_grid_view` (`UserEmail`,`PageId`,`GridId`,`ViewName`)');
CALL _schema_sync_add_index('compl_user_grid_preference', 'idx_user_grid_user_email', 'KEY `idx_user_grid_user_email` (`UserEmail`)');
CALL _schema_sync_add_index('compl_user_grid_preference', 'idx_user_grid_page_grid', 'KEY `idx_user_grid_page_grid` (`PageId`,`GridId`)');
CALL _schema_sync_add_index('compl_user_grid_preference', 'idx_user_grid_default', 'KEY `idx_user_grid_default` (`UserEmail`,`PageId`,`GridId`,`IsDefault`)');
CALL _schema_sync_add_index('eutr_documents', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('eutr_master_documents', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('eutr_master_documents', 'eutr_master_documents_stepid_foreign', 'KEY `eutr_master_documents_stepid_foreign` (`StepId`)');
CALL _schema_sync_add_index('eutr_purchase_attachments', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('eutr_purchase_attachments', 'eutr_purchase_attachments_templatecode_foreign', 'KEY `eutr_purchase_attachments_templatecode_foreign` (`TemplateCode`)');
CALL _schema_sync_add_index('eutr_purchase_missing', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('eutr_reference_details', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('eutr_reference_details', 'eutr_reference_details_refid_foreign', 'KEY `eutr_reference_details_refid_foreign` (`RefId`)');
CALL _schema_sync_add_index('eutr_reference_type_details', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('eutr_reference_type_details', 'eutr_reference_type_details_typeid_foreign', 'KEY `eutr_reference_type_details_typeid_foreign` (`TypeId`)');
CALL _schema_sync_add_index('eutr_reference_type_details', 'eutr_reference_type_details_stepid_foreign', 'KEY `eutr_reference_type_details_stepid_foreign` (`StepId`)');
CALL _schema_sync_add_index('eutr_reference_types', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('eutr_references', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('eutr_references', 'eutr_references_documentid_foreign', 'KEY `eutr_references_documentid_foreign` (`DocumentId`)');
CALL _schema_sync_add_index('eutr_references', 'eutr_references_refid_foreign', 'KEY `eutr_references_refid_foreign` (`RefId`)');
CALL _schema_sync_add_index('eutr_references', 'eutr_references_reftype_foreign', 'KEY `eutr_references_reftype_foreign` (`RefType`)');
CALL _schema_sync_add_index('eutr_steps', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('eutr_template_details', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('eutr_template_details', 'eutr_template_details_templateid_foreign', 'KEY `eutr_template_details_templateid_foreign` (`TemplateId`)');
CALL _schema_sync_add_index('eutr_template_details', 'eutr_template_details_stepid_foreign', 'KEY `eutr_template_details_stepid_foreign` (`StepId`)');
CALL _schema_sync_add_index('eutr_template_details', 'eutr_template_details_takefrom_foreign', 'KEY `eutr_template_details_takefrom_foreign` (`TakeFrom`)');
CALL _schema_sync_add_index('eutr_template_references', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('eutr_template_references', 'eutr_template_references_templateid_foreign', 'KEY `eutr_template_references_templateid_foreign` (`TemplateId`)');
CALL _schema_sync_add_index('eutr_templates', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('eutr_templates', 'eutr_templates_code_index', 'KEY `eutr_templates_code_index` (`Code`)');
CALL _schema_sync_add_index('eutr_templates', 'eutr_templates_ishide_index', 'KEY `eutr_templates_ishide_index` (`IsHide`)');
CALL _schema_sync_add_index('eutr_templates', 'eutr_templates_isdeleted_index', 'KEY `eutr_templates_isdeleted_index` (`IsDeleted`)');
CALL _schema_sync_add_index('hf_AggregatedCounter', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('hf_AggregatedCounter', 'IX_hf_CounterAggregated_Key', 'UNIQUE KEY `IX_hf_CounterAggregated_Key` (`Key`)');
CALL _schema_sync_add_index('hf_Counter', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('hf_Counter', 'IX_hf_Counter_Key', 'KEY `IX_hf_Counter_Key` (`Key`)');
CALL _schema_sync_add_index('hf_Hash', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('hf_Hash', 'IX_hf_Hash_Key_Field', 'UNIQUE KEY `IX_hf_Hash_Key_Field` (`Key`,`Field`)');
CALL _schema_sync_add_index('hf_Job', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('hf_Job', 'IX_hf_Job_StateName', 'KEY `IX_hf_Job_StateName` (`StateName`)');
CALL _schema_sync_add_index('hf_JobParameter', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('hf_JobParameter', 'IX_hf_JobParameter_JobId_Name', 'UNIQUE KEY `IX_hf_JobParameter_JobId_Name` (`JobId`,`Name`)');
CALL _schema_sync_add_index('hf_JobParameter', 'FK_hf_JobParameter_Job', 'KEY `FK_hf_JobParameter_Job` (`JobId`)');
CALL _schema_sync_add_index('hf_JobQueue', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('hf_JobQueue', 'IX_hf_JobQueue_QueueAndFetchedAt', 'KEY `IX_hf_JobQueue_QueueAndFetchedAt` (`Queue`,`FetchedAt`)');
CALL _schema_sync_add_index('hf_JobState', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('hf_JobState', 'FK_hf_JobState_Job', 'KEY `FK_hf_JobState_Job` (`JobId`)');
CALL _schema_sync_add_index('hf_List', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('hf_Server', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('hf_Set', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('hf_Set', 'IX_hf_Set_Key_Value', 'UNIQUE KEY `IX_hf_Set_Key_Value` (`Key`,`Value`)');
CALL _schema_sync_add_index('hf_State', 'PRIMARY', 'PRIMARY KEY (`Id`)');
CALL _schema_sync_add_index('hf_State', 'FK_hf_HangFire_State_Job', 'KEY `FK_hf_HangFire_State_Job` (`JobId`)');


-- Add missing foreign keys after all referenced tables/columns exist.

CALL _schema_sync_add_foreign_key('compl_compliance_group_email', 'FK_Compliance', 'CONSTRAINT `FK_Compliance` FOREIGN KEY (`ComplianceId`) REFERENCES `compl_compliances` (`Id`) ON DELETE CASCADE');
CALL _schema_sync_add_foreign_key('compl_compliance_group_email', 'FK_GroupEmail', 'CONSTRAINT `FK_GroupEmail` FOREIGN KEY (`GroupEmailId`) REFERENCES `compl_group_email` (`Id`) ON DELETE CASCADE');
CALL _schema_sync_add_foreign_key('compl_compliances', 'fk_compliance_document_type', 'CONSTRAINT `fk_compliance_document_type` FOREIGN KEY (`DocumentTypeId`) REFERENCES `compl_document_type` (`Id`) ON DELETE RESTRICT');
CALL _schema_sync_add_foreign_key('compl_country_group_members', 'fk_cgm_group', 'CONSTRAINT `fk_cgm_group` FOREIGN KEY (`GroupId`) REFERENCES `compl_country_groups` (`Id`) ON DELETE CASCADE');
CALL _schema_sync_add_foreign_key('compl_group_email_detail', 'compl_group_email_detail_ibfk_1', 'CONSTRAINT `compl_group_email_detail_ibfk_1` FOREIGN KEY (`GroupEmailId`) REFERENCES `compl_group_email` (`Id`) ON DELETE CASCADE');
CALL _schema_sync_add_foreign_key('compl_master_condition_values', 'compl_master_condition_values_ibfk_1', 'CONSTRAINT `compl_master_condition_values_ibfk_1` FOREIGN KEY (`ConditionId`) REFERENCES `compl_master_conditions` (`Id`) ON DELETE CASCADE');
CALL _schema_sync_add_foreign_key('compl_master_conditions', 'fk_compl_master_conditions_reference_type', 'CONSTRAINT `fk_compl_master_conditions_reference_type` FOREIGN KEY (`RefTypeId`) REFERENCES `compl_reference_types` (`Id`) ON DELETE RESTRICT');
CALL _schema_sync_add_foreign_key('compl_master_conditions', 'fk_compl_masters_condition', 'CONSTRAINT `fk_compl_masters_condition` FOREIGN KEY (`MasterId`) REFERENCES `compl_masters` (`Id`) ON DELETE CASCADE');
CALL _schema_sync_add_foreign_key('compl_master_default_configs', 'fk_mdc_trigger', 'CONSTRAINT `fk_mdc_trigger` FOREIGN KEY (`TriggerId`) REFERENCES `compl_ref_trigger` (`Id`) ON DELETE RESTRICT');
CALL _schema_sync_add_foreign_key('compl_master_default_configs', 'fk_mdc_trigger_ref', 'CONSTRAINT `fk_mdc_trigger_ref` FOREIGN KEY (`TriggerRefTypeId`) REFERENCES `compl_reference_types` (`Id`) ON DELETE RESTRICT');
CALL _schema_sync_add_foreign_key('compl_master_default_template_condition_values', 'fk_tcv_condition', 'CONSTRAINT `fk_tcv_condition` FOREIGN KEY (`ConditionId`) REFERENCES `compl_master_default_template_conditions` (`Id`) ON DELETE CASCADE');
CALL _schema_sync_add_foreign_key('compl_master_default_template_conditions', 'fk_tc_ref_type', 'CONSTRAINT `fk_tc_ref_type` FOREIGN KEY (`RefTypeId`) REFERENCES `compl_reference_types` (`Id`) ON DELETE RESTRICT');
CALL _schema_sync_add_foreign_key('compl_master_default_template_conditions', 'fk_tc_template', 'CONSTRAINT `fk_tc_template` FOREIGN KEY (`TemplateId`) REFERENCES `compl_master_default_templates` (`Id`) ON DELETE CASCADE');
CALL _schema_sync_add_foreign_key('compl_master_default_template_group_email', 'FK_Master_Default', 'CONSTRAINT `FK_Master_Default` FOREIGN KEY (`TemplateId`) REFERENCES `compl_master_default_templates` (`Id`) ON DELETE CASCADE');
CALL _schema_sync_add_foreign_key('compl_master_default_template_group_email', 'FK_Master_Default_GroupEmail', 'CONSTRAINT `FK_Master_Default_GroupEmail` FOREIGN KEY (`GroupEmailId`) REFERENCES `compl_group_email` (`Id`) ON DELETE CASCADE');
CALL _schema_sync_add_foreign_key('compl_master_default_templates', 'fk_tmpl_config', 'CONSTRAINT `fk_tmpl_config` FOREIGN KEY (`ConfigId`) REFERENCES `compl_master_default_configs` (`Id`) ON DELETE CASCADE');
CALL _schema_sync_add_foreign_key('compl_master_default_trigger_condition_values', 'fk_mdtcv_condition', 'CONSTRAINT `fk_mdtcv_condition` FOREIGN KEY (`ConditionId`) REFERENCES `compl_master_default_trigger_conditions` (`Id`) ON DELETE CASCADE');
CALL _schema_sync_add_foreign_key('compl_master_default_trigger_conditions', 'fk_mdtc_config', 'CONSTRAINT `fk_mdtc_config` FOREIGN KEY (`ConfigId`) REFERENCES `compl_master_default_configs` (`Id`) ON DELETE CASCADE');
CALL _schema_sync_add_foreign_key('compl_master_default_trigger_conditions', 'fk_mdtc_trigger', 'CONSTRAINT `fk_mdtc_trigger` FOREIGN KEY (`TriggerId`) REFERENCES `compl_ref_trigger` (`Id`) ON DELETE RESTRICT');
CALL _schema_sync_add_foreign_key('compl_master_default_trigger_conditions', 'fk_mdtc_trigger_ref', 'CONSTRAINT `fk_mdtc_trigger_ref` FOREIGN KEY (`TriggerRefTypeId`) REFERENCES `compl_reference_types` (`Id`) ON DELETE RESTRICT');
CALL _schema_sync_add_foreign_key('compl_master_group_email', 'FK_Master', 'CONSTRAINT `FK_Master` FOREIGN KEY (`MasterId`) REFERENCES `compl_masters` (`Id`) ON DELETE CASCADE');
CALL _schema_sync_add_foreign_key('compl_master_group_email', 'FK_Master_GroupEmail', 'CONSTRAINT `FK_Master_GroupEmail` FOREIGN KEY (`GroupEmailId`) REFERENCES `compl_group_email` (`Id`) ON DELETE CASCADE');
CALL _schema_sync_add_foreign_key('compl_ref_tracked_objects', 'fk_tracked_ref_type', 'CONSTRAINT `fk_tracked_ref_type` FOREIGN KEY (`RefTypeId`) REFERENCES `compl_reference_types` (`Id`) ON DELETE RESTRICT');
CALL _schema_sync_add_foreign_key('compl_ref_tracked_objects', 'fk_tracked_trigger', 'CONSTRAINT `fk_tracked_trigger` FOREIGN KEY (`TriggerId`) REFERENCES `compl_ref_trigger` (`Id`) ON DELETE RESTRICT');
CALL _schema_sync_add_foreign_key('compl_ref_trigger', 'fk_compl_ref_trigger', 'CONSTRAINT `fk_compl_ref_trigger` FOREIGN KEY (`RefTypeId`) REFERENCES `compl_reference_types` (`Id`) ON DELETE RESTRICT');
CALL _schema_sync_add_foreign_key('compl_references', 'fk_compl_references_compliance', 'CONSTRAINT `fk_compl_references_compliance` FOREIGN KEY (`ComplianceId`) REFERENCES `compl_compliances` (`Id`) ON DELETE RESTRICT');
CALL _schema_sync_add_foreign_key('compl_references', 'fk_compl_references_master', 'CONSTRAINT `fk_compl_references_master` FOREIGN KEY (`MasterId`) REFERENCES `compl_masters` (`Id`) ON DELETE RESTRICT');
CALL _schema_sync_add_foreign_key('compl_references', 'fk_compl_references_reference_type', 'CONSTRAINT `fk_compl_references_reference_type` FOREIGN KEY (`RefTypeId`) REFERENCES `compl_reference_types` (`Id`) ON DELETE RESTRICT');
CALL _schema_sync_add_foreign_key('eutr_master_documents', 'eutr_master_documents_stepid_foreign', 'CONSTRAINT `eutr_master_documents_stepid_foreign` FOREIGN KEY (`StepId`) REFERENCES `eutr_steps` (`Id`)');
CALL _schema_sync_add_foreign_key('eutr_purchase_attachments', 'eutr_purchase_attachments_templatecode_foreign', 'CONSTRAINT `eutr_purchase_attachments_templatecode_foreign` FOREIGN KEY (`TemplateCode`) REFERENCES `eutr_templates` (`Code`)');
CALL _schema_sync_add_foreign_key('eutr_reference_details', 'eutr_reference_details_refid_foreign', 'CONSTRAINT `eutr_reference_details_refid_foreign` FOREIGN KEY (`RefId`) REFERENCES `eutr_references` (`Id`)');
CALL _schema_sync_add_foreign_key('eutr_reference_type_details', 'eutr_reference_type_details_stepid_foreign', 'CONSTRAINT `eutr_reference_type_details_stepid_foreign` FOREIGN KEY (`StepId`) REFERENCES `eutr_steps` (`Id`)');
CALL _schema_sync_add_foreign_key('eutr_reference_type_details', 'eutr_reference_type_details_typeid_foreign', 'CONSTRAINT `eutr_reference_type_details_typeid_foreign` FOREIGN KEY (`TypeId`) REFERENCES `eutr_reference_types` (`Id`)');
CALL _schema_sync_add_foreign_key('eutr_references', 'eutr_references_documentid_foreign', 'CONSTRAINT `eutr_references_documentid_foreign` FOREIGN KEY (`DocumentId`) REFERENCES `eutr_documents` (`Id`)');
CALL _schema_sync_add_foreign_key('eutr_references', 'eutr_references_refid_foreign', 'CONSTRAINT `eutr_references_refid_foreign` FOREIGN KEY (`RefId`) REFERENCES `eutr_template_details` (`Id`)');
CALL _schema_sync_add_foreign_key('eutr_template_details', 'eutr_template_details_stepid_foreign', 'CONSTRAINT `eutr_template_details_stepid_foreign` FOREIGN KEY (`StepId`) REFERENCES `eutr_steps` (`Id`)');
CALL _schema_sync_add_foreign_key('eutr_template_details', 'eutr_template_details_takefrom_foreign', 'CONSTRAINT `eutr_template_details_takefrom_foreign` FOREIGN KEY (`TakeFrom`) REFERENCES `eutr_reference_types` (`Id`)');
CALL _schema_sync_add_foreign_key('eutr_template_details', 'eutr_template_details_templateid_foreign', 'CONSTRAINT `eutr_template_details_templateid_foreign` FOREIGN KEY (`TemplateId`) REFERENCES `eutr_templates` (`Id`)');
CALL _schema_sync_add_foreign_key('eutr_template_references', 'eutr_template_references_templateid_foreign', 'CONSTRAINT `eutr_template_references_templateid_foreign` FOREIGN KEY (`TemplateId`) REFERENCES `eutr_templates` (`Id`)');
CALL _schema_sync_add_foreign_key('hf_JobParameter', 'FK_hf_JobParameter_Job', 'CONSTRAINT `FK_hf_JobParameter_Job` FOREIGN KEY (`JobId`) REFERENCES `hf_Job` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE');
CALL _schema_sync_add_foreign_key('hf_JobState', 'FK_hf_JobState_Job', 'CONSTRAINT `FK_hf_JobState_Job` FOREIGN KEY (`JobId`) REFERENCES `hf_Job` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE');
CALL _schema_sync_add_foreign_key('hf_State', 'FK_hf_HangFire_State_Job', 'CONSTRAINT `FK_hf_HangFire_State_Job` FOREIGN KEY (`JobId`) REFERENCES `hf_Job` (`Id`) ON DELETE CASCADE ON UPDATE CASCADE');
...
-- Stored functions/procedures. Replacing routines does not modify table data.
...
DELIMITER ;;
CREATE FUNCTION `compl_fn_get_rule_count`(
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_export_master_template`(IN p_created_by VARCHAR(255))
BEGIN
    /*
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_alert_compliances`(
    IN p_ids TEXT,
    IN p_type INT
)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_alert_master_compliances`(
    IN p_ids TEXT
)
BEGIN
	-- CTE để aggregate email groups theo MasterId
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_all_related_compliances`(
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_compliances_by_master_id_static_paging`(
    IN p_limit INT,
    IN p_offset INT,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_compliances_by_master_id_static_paging_count`(
    IN p_search_text VARCHAR(255),
    IN p_due_days INT,
    IN p_user_email VARCHAR(50),
    IN p_master_id BIGINT,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_compliance_by_reference_dashboard`(
    IN p_due_days INT,
    IN p_user_email VARCHAR(50)
)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_compliance_detail_for_export`(IN p_created_by VARCHAR(255))
BEGIN
    SELECT
        m.Code                  AS MasterCode,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_compliance_file_names`(
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_compliance_summary_dashboard`(
    IN p_due_days INT,
    IN p_user_email VARCHAR(50)
)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_compl_compliances_for_search`(
    IN p_limit INT,
    IN p_offset INT,    
    IN p_search_text VARCHAR(255),
    IN p_user_email VARCHAR(50)
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_compl_compliances_for_search_count`(
    IN p_search_text VARCHAR(255),
    IN p_user_email VARCHAR(50)
)
BEGIN	
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_compl_compliances_paging`(
    IN p_limit INT,
    IN p_offset INT,
    IN p_order_column VARCHAR(50),
    IN p_order_direction VARCHAR(4),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_compl_compliances_paging_count`(
    IN p_search_text VARCHAR(255),  
    IN p_due_days INT,
    IN p_user_email VARCHAR(50),
    IN p_ref_type_id BIGINT,        
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_compl_compliances_paging_masters_json`(
    IN p_limit INT,
    IN p_offset INT,
    IN p_order_column VARCHAR(50),
    IN p_order_direction VARCHAR(4),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_compl_master_by_code`(IN p_code VARCHAR(50))
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_compl_master_by_id`(IN p_id BIGINT)
BEGIN
    SELECT
		c.Id,
        c.Code,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_compl_master_condition`(IN p_master_id INT)
BEGIN
SELECT JSON_ARRAYAGG(
                JSON_OBJECT(
                    'id', cmc.Id,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_compl_master_missing`(
    IN p_user_email VARCHAR(50)
)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_compl_master_missing_for_alert`(
    IN p_user_email VARCHAR(50)
)
BEGIN
    WITH LatestVersions AS (
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_compl_master_paging`(
    IN p_limit INT,
    IN p_offset INT,
    IN p_order_column VARCHAR(50),
    IN p_order_direction VARCHAR(4),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_compl_master_paging_count`(
    IN p_search_text VARCHAR(255),
    IN p_due_days INT,
    IN p_user_email VARCHAR(50),
    IN p_ref_type_id BIGINT,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_compl_master_paging_search_condition`(
    IN p_limit INT,
    IN p_offset INT,
    IN p_order_column VARCHAR(50),
    IN p_order_direction VARCHAR(4),
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_next_code`(IN p_prefix VARCHAR(20),  IN p_user_email VARCHAR(50), OUT p_code VARCHAR(50))
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `compl_sp_get_pie_chart_dashboard`(
    IN p_user_email VARCHAR(50)
)
BEGIN
    SELECT JSON_ARRAYAGG(
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `sp_audit_all_duplicate_conditions`()
BEGIN
    /*
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `sp_get_unmapped_files_by_creator`(
    IN p_limit INT,
    IN p_offset INT,
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `sp_get_unmapped_files_by_creator_count`(
    IN p_created_by VARCHAR(255)  
)
BEGIN
    SELECT 
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `sp_load_compl_by_conditions`(
    IN p_json_data JSON,
    IN p_check_date DATE
)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `sp_load_compl_by_conditions_count`(
    IN p_json_data JSON,
    IN p_check_date DATE
)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `sp_load_compl_by_conditions_show`(
    IN p_json_data JSON,
    IN p_check_date DATE
)
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `sp_mark_notifications_as_read`(
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE PROCEDURE `sp_process_master_defaults`(
...
-- Restore connection settings and release the advisory lock.
SET time_zone = @schema_sync_old_time_zone;
SET sql_mode = @schema_sync_old_sql_mode;
SET foreign_key_checks = @schema_sync_old_foreign_key_checks;
SET unique_checks = @schema_sync_old_unique_checks;
SET character_set_client = @schema_sync_old_character_set_client;
SET character_set_results = @schema_sync_old_character_set_results;
SET collation_connection = @schema_sync_old_collation_connection;
SELECT RELEASE_LOCK(CONCAT(DATABASE(), ':compliance_live_schema_sync'))
  INTO @schema_sync_lock_released;

-- End of additive live schema sync.
