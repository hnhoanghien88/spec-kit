...
- **FR-021 (Cập nhật ở Update 16 — thêm Status)**: Giao diện danh sách **TemplateListPage** MUST
  hiển thị dạng Table (không phải DataGrid nhiều cột) kèm ô tìm kiếm phía trên, theo đúng bố cục
  của thiết kế tham chiếu `TemplateListPage.jsx`. Mỗi dòng MUST hiển thị: ô tên gồm 2 dòng chữ —
