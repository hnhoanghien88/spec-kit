...
10. **(2026-09-03, recipient-group exclusion)** The email's To/Cc addressing and the in-app notification recipients (side effect 2) no longer include any email address from the Alert emails recipient group — only the Responsible emails group receives this trigger's alert. This does not change the alert's content (side effects 4-8 above are unaffected); it only narrows who receives it (spec.md FR-026, FR-028, research.md R17).
